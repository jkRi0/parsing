...
import { PrimaryExpressionContext } from "./JavaParser";
import { SquareBracketExpressionContext } from "./JavaParser";
import { MemberReferenceExpressionContext } from "./JavaParser";
import { MethodCallExpressionContext } from "./JavaParser";
import { MethodReferenceExpressionContext } from "./JavaParser";
import { ExpressionSwitchContext } from "./JavaParser";
import { PostIncrementDecrementOperatorExpressionContext } from "./JavaParser";
import { UnaryOperatorExpressionContext } from "./JavaParser";
import { CastExpressionContext } from "./JavaParser";
import { ObjectCreationExpressionContext } from "./JavaParser";
import { BinaryOperatorExpressionContext } from "./JavaParser";
import { InstanceOfOperatorExpressionContext } from "./JavaParser";
import { TernaryExpressionContext } from "./JavaParser";
import { ExpressionLambdaContext } from "./JavaParser";
import { CompilationUnitContext } from "./JavaParser";
import { ModularCompulationUnitContext } from "./JavaParser";
...
import { CompactConstructorDeclarationContext } from "./JavaParser";
...
import { PackageNameContext } from "./JavaParser";
...
import { AnnotationFieldValuesContext } from "./JavaParser";
import { AnnotationFieldValueContext } from "./JavaParser";
import { AnnotationValueContext } from "./JavaParser";
...
import { ComponentPatternListContext } from "./JavaParser";
import { ComponentPatternContext } from "./JavaParser";
...
import { GuardContext } from "./JavaParser";
import { CasePatternContext } from "./JavaParser";
...
export interface JavaParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	enterMemberReferenceExpression?: (ctx: MemberReferenceExpressionContext) => void;
	/**
	 * Exit a parse tree produced by the `MemberReferenceExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 */
	exitMemberReferenceExpression?: (ctx: MemberReferenceExpressionContext) => void;
	 ...
	 * @param ctx the parse tree
	 */
	enterMethodReferenceExpression?: (ctx: MethodReferenceExpressionContext) => void;
	/**
	 * Exit a parse tree produced by the `MethodReferenceExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 */
	exitMethodReferenceExpression?: (ctx: MethodReferenceExpressionContext) => void;
	 ...
	 * @param ctx the parse tree
	 */
	enterPostIncrementDecrementOperatorExpression?: (ctx: PostIncrementDecrementOperatorExpressionContext) => void;
	/**
	 * Exit a parse tree produced by the `PostIncrementDecrementOperatorExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 */
	exitPostIncrementDecrementOperatorExpression?: (ctx: PostIncrementDecrementOperatorExpressionContext) => void;
	 ...
	 * @param ctx the parse tree
	 */
	enterInstanceOfOperatorExpression?: (ctx: InstanceOfOperatorExpressionContext) => void;
	/**
	 * Exit a parse tree produced by the `InstanceOfOperatorExpression`
	 * labeled alternative in `JavaParser.expression`.
	 * @param ctx the parse tree
	 */
	exitInstanceOfOperatorExpression?: (ctx: InstanceOfOperatorExpressionContext) => void;
