...
export default class JavaParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by JavaParser#modularCompulationUnit.
	visitModularCompulationUnit(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by JavaParser#annotationFieldValues.
	visitAnnotationFieldValues(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by JavaParser#annotationFieldValue.
	visitAnnotationFieldValue(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by JavaParser#annotationValue.
	visitAnnotationValue(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitInstanceOfOperatorExpression(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by JavaParser#componentPatternList.
	visitComponentPatternList(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by JavaParser#componentPattern.
	visitComponentPattern(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by JavaParser#guard.
	visitGuard(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by JavaParser#casePattern.
	visitCasePattern(ctx) {
	  return this.visitChildren(ctx);
	}
