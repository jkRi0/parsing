...
export default class CSharpParserVisitor extends antlr4.tree.ParseTreeVisitor {

	// Visit a parse tree produced by CSharpParser#compilation_unit.
	visitCompilation_unit(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CSharpParser#namespace_or_type_name.
	visitNamespace_or_type_name(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitNon_assignment_expression(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitStruct_member_declaration(ctx) {
	  return this.visitChildren(ctx);
	}
